...
abstract class baseModel {
		...
		{
			return $this->DAO->getSearchForItem($id , $id2);
		}
		...
		//needed for some API calls ie REST get /resource/:id/
		public function updateItemValue($id , $id2 , $id3)
		{
			return $this->DAO->updateItemValue($id , $id2, $id3);
		}
		// get just one select from database a Object with ID   
		public function getItemValue($id , $id2)
		{
			
			return $this->DAO->getItemValue($id , $id2);
		}
