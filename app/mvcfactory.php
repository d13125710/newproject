...
class MVCFactory {
	...
	function makeQuestionMVC($action ,$app ,$parameters=null) {
        return new questionMVC($action ,$app ,$parameters);
   	}
...
class questionMVC extends AbstractMVC {
    ...
    function __construct($action ,$app ,$parameters=null)
    {
		...
		$this->controller = new questionController($this->model ,$this->action ,$this->app , $this->parameters);
		$this->show();
